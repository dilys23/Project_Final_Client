...
function ResetPass() {
    ...
    const handleSubmit = (event) => {
        ...
        handleChangePass(email, password);
    ...
    return (
        <div className="login-page">
            ...
            <form action="" onSubmit={handleSubmit}>
                <input type="password" className="btn-password" placeholder="* New Password" value={password} onChange={handlePasswordChange}/>
                <input type="password" className="btn-confirm" placeholder="* Confirm New Password" value={confirmPassword} onChange={handleConfirmPasswordChange} />
